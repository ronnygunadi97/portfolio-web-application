          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="mt-16 flex flex-wrap justify-center gap-8 text-sm text-slate-400 font-medium tracking-wider uppercase">
              <div className="flex items-center gap-2">
                <a href={`https://wa.me/${personalInfo.contact.phone.replace(/^0/, '62')}`} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-emerald-300 transition-colors">
